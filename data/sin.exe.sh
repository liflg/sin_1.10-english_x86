...
if [ -f "ref_gl.so.gz" -o -f "ref_soft.so.gz" -o -f "sin.exe.gz" -o -f "base/game.so.gz" -o ! -f "sin.exe" -o  ! -r "sin.exe" -o ! -x "sin.exe" -o "x`md5sum sin.exe|awk '{print $1}'`" = "xff3f64a7c8fd5d64439a87bcb5c703a7" ] #UGLY!
then
    ./registergui.sh
fi
